...
export function Previous({ handlePrevious }: HandlePreviousProps) {
  return (
    <div
      ...
      className='absolute flex justify-center items-center left-5 bg-[#000000]   m-auto top-0 bottom-0 h-[40px] w-[40px]'
    >
      <svg
...
export function Next({ handleNext }: HandleNextProps) {
  return (
    <div
      onClick={handleNext}
      className='absolute flex justify-center items-center right-5 bg-black text-white  m-auto top-0 bottom-0 h-[40px] w-[40px]'
    >
      <svg
        xmlns='http://www.w3.org/2000/svg'
        height='20'
